# Experimental pygame-ce recipe vendored ONLY for the disposable Android test branch.
# Based on python-for-android PR #2838 (pygame-ce Android recipe).
...
class PygameCeRecipe(CompiledComponentsPythonRecipe):
    """Build SDL2-based pygame-ce for Android (experimental)."""
